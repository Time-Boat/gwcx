...
//	@Pointcut("@annotation(com.yhy.lin.app.quartz.BussAnnotation)")  
...
////    }
//    
//    @Pointcut("execution(* com.yhy.lin.controller.*.*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping) ") 
