...
public interface TransferServiceI extends CommonService {
	...
	public JSONObject getDatagrid1(TransferorderEntity transferorder, DataGrid dataGrid,String lineOrderCode,String orderTypes,String orderStartingstation,String orderTerminusstation,String lineId, String driverName,String plate,String fc_begin,
			String fc_end,String ddTime_begin, String ddTime_end);
	public JSONObject getDatagrid2(TransferorderEntity transferorder, DataGrid dataGrid,String lineOrderCode,String orderTypes,String orderStartingstation,String orderTerminusstation,String lineId, String driverName,String plate,String fc_begin,
			String fc_end,String ddTime_begin, String ddTime_end);
