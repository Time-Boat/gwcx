...
public class APIHttpClient2 {  
	...
	//订票人数确定总价
	private static String apiURL = "http://localhost:8080/gwcx/charteredApp.do?getChargesDetails";  
	
    private Log logger = LogFactory.getLog(this.getClass());  
    private static final String pattern = "yyyy-MM-dd HH:mm:ss:SSS";  
    private HttpClient httpClient = null;  
    private static APIHttpClient2 ahc = null;  
...
//    }
     ...
     * @param url 
     */  
    public APIHttpClient2(String url) {  
...
//		APIHttpClient ac = new APIHttpClient("http://localhost:8080/gwcx/wx.do?wxOauth2");
    	APIHttpClient2 ac = new APIHttpClient2(apiURL);
        JsonArray arry = new JsonArray();
        JsonObject j = new JsonObject();
//        System.out.println(ac.get());
        
        /*
        j.addProperty("token", "c1f00ace742f9f439e4b8501a72fea81");
        j.addProperty("cityId", "520100");*/
        /*j.addProperty("address", "2");
        j.addProperty("phone", "15159732758");
        j.addProperty("applyPeople", "j1");
        j.addProperty("code", "510");
        j.addProperty("email", "123@aa");*/
        /*j.addProperty("cityId", "520100");
         *   j.addProperty("userType", "0,1");
        j.addProperty("serveType", "2");
        j.addProperty("stationId", "ff8080815f89c7a1015f8b7254c2011c");
        j.addProperty("userType", "0,1");
        j.addProperty("serveType", "2");
        j.addProperty("stationId", "ff8080815f89c7a1015f8b7254c2011c");*/
        /*j.addProperty("token", "c1f00ace742f9f439e4b8501a72fea81");
        j.addProperty("packageId", "4028821e602e951801602f18a1f3000d");
        j.addProperty("carType", "2");
        j.addProperty("charteredType", "0");
        j.addProperty("actualMileage", "100");*/
       /* j.addProperty("token", "c1f00ace742f9f439e4b8501a72fea81");
        j.addProperty("packagePriceId", "A02");*/
        //登录接口
        //j.addProperty("mobile", "15527916902");  
        //j.addProperty("code", "1325");  
        j.addProperty("token", "c1f00ace742f9f439e4b8501a72fea81"); 
        j.addProperty("departCode", "A02A10"); 
		
        /*j.addProperty("signature", "ff8080815f89c7a1025f8b4a8a6a00d0");
        j.addProperty("timestamp", "2017121311551023");
        j.addProperty("nonce", "152556256");
        j.addProperty("echostr", "bgfbhfgh");*/
        //接送机订单测试
...
//		j.addProperty("token", "12f9152b7f0649d6f73ada1efe0a83dd"); 
		...
		//订票人数确定总价
	/*	j.addProperty("sumPeople", "10"); 
		j.addProperty("lineId", "2c93241660449c1b016044b9e16700cc");
		j.addProperty("token", "c1f00ace742f9f439e4b8501a72fea81");
		j.addProperty("phone", "18286410267");*/
