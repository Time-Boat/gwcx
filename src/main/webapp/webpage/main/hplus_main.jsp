...
<script>
    ...
    (function (jQuery){
    	...
    	this.layers = {'width' : 200, 'height': 100};
    	...
    	this.inits = function(title, text){
    		...
    		$(document.body).prepend('<div id="message" style="border:#b9c9ef 1px solid;z-index:9999;width:'+this.layers.width+'px;height:'+this.layers.height+'px;position:absolute; display:none;background:#2F4050; bottom:0; right:0; overflow:hidden;"><div style="border:1px solid #fff;border-bottom:none;width:100%;height:25px;font-size:12px;overflow:hidden;color:#FFFFFF;"><span id="message_close" style="float:right;padding:5px 0 5px 0;width:16px;line-height:auto;color:red;font-size:20px;font-weight:bold;text-align:center;cursor:pointer;overflow:hidden;">×</span><div style="padding:5px 0 5px 5px;width:100px;line-height:18px;text-align:left;overflow:hidden;">'+title+'</div><div style="clear:both;"></div></div> <div style="padding-bottom:5px;border:1px solid #fff;width:100%;height:auto;font-size:12px;"><div id="message_content" style="text-decoration:none;margin:0 5px 0 5px;padding:10px 0 10px 5px;font-size:14px;width:'+(this.layers.width-17)+'px;height:'+(this.layers.height-50)+'px;color:#FFFFFF;text-align:left;overflow:hidden;">'+text+'</div></div></div>');
    	...
    	this.lays = function(width, height){
    		...
    		if(width!=0 && width)this.layers.width = width;

    		if(height!=0 && height)this.layers.height = height;
