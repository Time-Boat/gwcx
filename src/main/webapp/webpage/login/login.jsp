                  ...
                  <div class="space-6"></div>
                      <label class="block clearfix">
								<span class="block input-icon input-icon-right">
									<input type="text"  name="userName" class="form-control" placeholder="请输入用户名"  id="userName" value="admin1"/>
                ...
                <div class="toolbar clearfix">
                  <div style="float: right">
                    ...
                    <a href="#"  class="forgot-password-link">
                      ...
                      <t:dictSelect id="langCode" field="langCode" typeGroupCode="lang" hasLabel="false" extendJson="{style:'padding:2px; width:80px;'}" defaultVal="zh-cn" readonly="readonly"></t:dictSelect>
                    </a>
                  </div>
                </div>
                </form>
