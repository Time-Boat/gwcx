...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="conductorController.do?save"  >
	...
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable" id = "formtableId">
		...
		<tr id= "add_phnoe">
			...
			<td class="value"><input  class="inputxt" name="phoneNumber" value="${conductor.phoneNumber}" datatype="m" errormsg="手机号码不正确!"> <span class="Validform_checktip"></span></td>
		</tr>
		<tr>
