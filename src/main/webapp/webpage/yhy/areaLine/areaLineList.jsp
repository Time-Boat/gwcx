...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="areaLineList" title="包车区域线路" actionUrl="areaLineController.do?datagrid" idField="id" fit="true">
   ...
   <t:dgCol title="线路类型 2：接机 3：送机 4：接火车 5：送火车" field="lineType"   width="120"></t:dgCol>
   <t:dgCol title="线路状态0:启用  1:未启用" field="status"   width="120"></t:dgCol>
   ...
   <t:dgCol title="出车时间段" field="dispath"   width="120"></t:dgCol>
