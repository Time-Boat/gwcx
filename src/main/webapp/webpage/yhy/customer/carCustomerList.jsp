...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="carCustomerList" title="乘客管理" actionUrl="carCustomerController.do?datagrid" fitColumns="true" queryMode="group" idField="id" fit="true">
   ...
   <t:dgCol title="手机号码" field="phone" query="true" align="center" width="60"></t:dgCol>
   <t:dgCol title="注册时间" field="createTime" align="center" formatter="yyyy-MM-dd hh:mm:ss"  width="100"></t:dgCol>
   <t:dgCol title="真实姓名" field="realName" query="true" align="center" width="50"></t:dgCol>
   <%-- <t:dgCol title="性别" field="sex"  width="120"></t:dgCol> --%>
   <t:dgCol title="身份证号码" field="cardNumber" align="center"  width="120"></t:dgCol>
   <t:dgCol title="居住地址" field="address" align="center"  width="120"></t:dgCol>
   <t:dgCol title="备注信息" field="remark" align="center"  width="120"></t:dgCol>
