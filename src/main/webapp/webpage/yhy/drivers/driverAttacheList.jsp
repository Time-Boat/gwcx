...
<div id="main_depart_list" class="easyui-layout" fit="true">
    <div region="center"  style="padding:0px;border:0px">
        <t:datagrid name="driverCurDepartUserList" title="common.operation"
...
<div style="display: none">
    <t:formvalid formid="formobj" layout="div" dialog="true" action="driversInfoController.do?driverAllotAttache&ids=${ids}" beforeSubmit="setUserId">
...
<script>
    ...
    function getUserListSelection(field) {
        var ids = [];
        var rows = $('#driverCurDepartUserList').datagrid('getSelections');
