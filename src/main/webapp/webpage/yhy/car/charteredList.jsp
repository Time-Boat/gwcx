...
<t:datagrid name="conductorList" title="包车订单列表" autoLoadData="true" actionUrl="roleController.do?roleGrid"  fitColumns="true"
	...
	<t:dgCol title="申请时间"  field="" query="true" align="center"  width="120"></t:dgCol>
	<t:dgCol title="发车时间"  field="" query="true" align="center"  width="120"></t:dgCol>
