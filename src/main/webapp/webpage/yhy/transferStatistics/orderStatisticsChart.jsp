...
<body>
		...
		<table align="center" cellpadding="10" cellspacing="0" class="formtable" id="formtables">
			...
			<td align="right" colspan="5" >
				...
				<div id="userinfo"> 
					...
					<t:dictSelect id="userType" field="type" extendJson="{onchange:getDealerinfo()}" typeGroupCode="userType" hasLabel="false"   ></t:dictSelect>	
				</div>
				<div id="dealerinfo" hidden="true">
					<label class="Validform_label"> &nbsp;&nbsp;渠道商: </label>
					<%-- <t:dictSelect id="dealer" field="type" extendJson="{onchange:getOrderStatisticsChart()}" typeGroupCode="userType" hasLabel="false" ></t:dictSelect>--%>
					<select id="dealer" name="dealer" onchange="getOrderStatisticsChart()">
    ...
    <div region="south" border="false" style="height: 600px; overflow: hidden;" id="southDiv">
     ...
     function getOrderStatisticsChart(){
    	 var userType = $("#userType").val();
    	 ...
    	 $.ajax({
				type : 'POST',
				url : "transferStatisticsController.do?getOrderStatisticsChart&userType="+userType+"&dealer="+dealer+"&startDate="+startDate+"&endDate="+endDate+"&timestamp="+timestamp,
				success : function(ds) {
					var obj = eval('(' + ds + ')');
