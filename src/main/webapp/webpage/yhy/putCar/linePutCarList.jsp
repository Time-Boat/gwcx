...
<t:base type="jquery,easyui,tools,DatePicker"></t:base>
	<div class="easyui-layout" fit="true">
		...
		<div id="p" data-options="region:'center'" title="" style="padding:0px;border:0px;">
			<t:datagrid name="roleList" title="线路排班" actionUrl="roleController.do?roleGrid" idField="id" fit="true" queryMode="group">
				...
				<t:dgCol title="司机姓名" field="" query="true"></t:dgCol>
				<t:dgCol title="司机联系电话" field="" query="true"></t:dgCol>
				<t:dgCol title="车牌号" field="" query="true"></t:dgCol>
