...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="feedbackInfoList" title="乘客反馈信息" actionUrl="feedbackInfoController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="乘客名称" field="realName" query="true" align="center" width="120"></t:dgCol>
   <t:dgCol title="乘客手机" field="phone" query="true" align="center" width="120"></t:dgCol>
   <t:dgCol title="反馈内容" field="content"  align="center" width="120"></t:dgCol>
   ...
   <t:dgToolBar title="查看反馈详细" icon="icon-search" url="feedbackInfoController.do?addorupdate" funname="detail"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>