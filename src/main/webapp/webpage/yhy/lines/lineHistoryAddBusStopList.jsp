...
<t:datagrid onLoadSuccess="selectRowFun" name="lineHistoryAddBusStopList" title="已挂接的线路站点" 
            actionUrl="lineinfoHistoryController.do?busStopByLineDatagrid&lineInfoId=${lineInfoId}" fit="true" fitColumns="true" idField="id" pageSize="100">
...
function delZd(id,line_busstopId){
	...
	$.dialog.confirm('确定要删除该记录吗？',function(r){
	    if (r){
	    	$.post(
	    		"lineinfoHistoryController.do?delLine_BusStop",	
				...
				function(data){
					...
					//alert(obj.msg);
					tip(obj.msg);
					$('#lineHistoryAddBusStopList').datagrid('reload');
				}
			);		
	    }
	});
