...
<div region="center" style="padding:0px;border:0px">
	<t:datagrid name="transferOrderList" title="接送火车订单处理" autoLoadData="true" actionUrl="transferOrderController.do?traindatagrid&lineOrderCode=${lineOrderCode}&orderType=${orderType}" fitColumns="true"
		...
		<t:dgCol title="订单状态" field="orderStatus" replace="待派车 _1,带出行_2" query="true" align="center"></t:dgCol>
