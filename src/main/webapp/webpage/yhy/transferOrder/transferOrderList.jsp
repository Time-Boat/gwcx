...
<div region="center" style="padding:0px;border:0px">
	<t:datagrid name="transferOrderList" title="接送火车订单处理" autoLoadData="true" actionUrl="transferOrderController.do?traindatagrid&lineOrderCode=${lineOrderCode}" fitColumns="true"
